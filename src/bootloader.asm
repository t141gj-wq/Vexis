...
; Windows-compatible NASM bootloader
...
print_string:
    ...
    mov bh, 0x00        ; Page 0
    mov bl, 0x0b        ; Bright cyan text attribute (0x0b = cyan on black)
...
; Banner data - exact layout as specified
...
banner_line3:   db 186, '  ', 234, '  V E X I S   C O M P U T I N G  ', 234, '   ', 186, 0x0d, 0x0a, 0
banner_line4:   db 186, '                                           ', 186, 0x0d, 0x0a, 0
banner_line5:   db 186, '   ', 176, 176, 176, 176, 219, 219, 219, 219, 219, 219, 219, 219, 219, 219, 219, 219, 219, 219, 219, 219, 219, 176, 176, 176, 176, '    ', 186, 0x0d, 0x0a, 0
